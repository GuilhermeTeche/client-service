...
@ControllerAdvice
public class ItauExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleInvalidKeySpecException(InvalidKeySpecException ex, WebRequest request) {
        String messageUser = messageSource.getMessage("message.invalidKey", null, LocaleContextHolder.getLocale());
        String messageDeveloper = ex.toString();
        List<Error> errors = Arrays.asList(new Error(messageUser, messageDeveloper));
        return handleExceptionInternal(ex, errors, new HttpHeaders(), HttpStatus.NOT_FOUND, request);
    }
    ...
    public ResponseEntity<Object> handleParseException(JOSEException ex, WebRequest request) {
    ...
    public ResponseEntity<Object> handleIllegalArgumentException(IllegalArgumentException ex, WebRequest request) {
        String messageUser = messageSource.getMessage("message.illegalargumentexception", null, LocaleContextHolder.getLocale());
        String messageDeveloper = ex.toString();
        List<Error> errors = Arrays.asList(new Error(messageUser, messageDeveloper));
        return handleExceptionInternal(ex, errors, new HttpHeaders(), HttpStatus.BAD_REQUEST, request);
    }
